...
namespace sanfengli.Common
{
    ...
    {
        public static string ych_weixintokenBase = "ych_weixintokenBase";
        public static string ych_weixintoken = "ych_weixintoken";
        public static string ychmange_weixintoken = "ychmaang_weixintoken";
