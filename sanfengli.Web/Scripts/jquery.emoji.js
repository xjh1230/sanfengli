            ...
            d.prototype = {
                _init: function () {
                    ...
                    for (var n, o, p, q, r, s, t, u, v, w, x, y = '<div class="emoji_container" id="emoji_container_' + j + '">',
                        ...
                        A = '<div class="emoji_tab" style="' + (1 !== m || k ? "" : "display:none;") + '"><div class="emoji_tab_prev"></div><div class="emoji_tab_list"><ul>', B = 0; m > B; B++) if (o = l[B].name || "group" + (B + 1), p = l[B].path, q = l[B].maxNum, r = l[B].excludeNums, s = l[B].file || ".jpg", t = l[B].placeholder || "{alias}", u = l[B].alias, v = l[B].title, w = 0, p && q) {
                    ...
                    a(c).on({
                        click: function (b) {
                            var c, d, e, f, g = b.target,
                                k = h.$content[0];
                            g === a(i)[0] ? (a("#emoji_container_" + j)[h.toggleFunc](), h.$content.focus()) : a(g).parents("#emoji_container_" + j).length > 0 ? (c = a(g).data("emoji_code") || a(g).parent().data("emoji_code"), d = a(g).data("emoji_tab"), c ? ("DIV" === k.nodeName ? (e = a("#emoji_container_" + j + ' a[data-emoji_code="' + c + '"] img').attr("src"), f = '<img class="emoji_icon" data-code="' + c + '" src="' + e + '"/>', h._insertAtCursor(k, f, !1)) : h._insertAtCursor(k, c), h.hide()) : d ? a(g).hasClass("selected") || (a("#emoji_container_" + j + " .emoji_icons").hide(), a("#emoji_container_" + j + " #" + d).show(), a(g).addClass("selected").siblings().removeClass("selected")) : a(g).hasClass("emoji_tab_prev") ? F > 1 && (a("#emoji_container_" + j + " .emoji_tab_list ul").css("margin-left", "-503" * (F - 2) + "px"), F--) : a(g).hasClass("emoji_tab_next") && E > F && (a("#emoji_container_" + j + " .emoji_tab_list ul").css("margin-left", "-503" * F + "px"), F++), h.$content.focus()) : a("#emoji_container_" + j + ":visible").length > 0 && (h.hide(), h.$content.focus())
                        }
                    }),
                ...
                if (i > 0) for (var k = 0; i > k; k++) if (a = h[k].path, b = h[k].file || ".jpg", c = h[k].placeholder, d = h[k].alias, a) if (d) {
                    ...
                    e = c.replace(new RegExp("{alias}", "gi"), "([\\s\\S]+?)"),
                        ...
                        g.$content.html(g.$content.html().replace(f,
                            function (c, d) {
                                var e = j[d];
                                return e ? '<img class="emoji_icon" data-code="' + c + '" src="' + a + e + b + '"/>' : c
                            }))
