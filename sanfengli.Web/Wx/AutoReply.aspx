<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AutoReply.aspx.cs" Inherits="sanfengli.Web.Wx.AutoReply" %>
            ...
            <div class="content_wrap">
                <div class="tab_navs clearfix">
                    <ul class="clearfix">
                        ...
                        <li class="on"><a href="AutoReply.aspx">消息自动回复</a></li>
...
<script>
    function getmediaImg() {
        ...
        $.post("AjaxHandler/MpHandler.ashx/GetMediaList", { type: 'img' }, function (result) {
            if (result.state && result.imgList != null&& result.imgList.length > 0) {
                $("#panel_img").html("");
    ...
    var replyType = "text";
    var mid = "";
    var eventKey = "ych_automsg";
    function init() {
        $.post("AjaxHandler/MsgReplyHandler.ashx/GetReplyEvent",
            { eventKey: eventKey},
            function (result) {
                if (result.state) {
    ...
    $(document).ready(function () {
        ...
        $("#js_save").click(function () {
            ...
            $.post("AjaxHandler/MsgReplyHandler.ashx/SaveReplyEvent",
                { replyType: replyType, replyContent: temp, eventKey: eventKey, eventType: "automsg" },
                function (result) {
                    if (result.state) {
                        layer.msg("保存成功",
                            {time:1500},function () {
