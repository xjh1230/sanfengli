    ...
    <div class="wrap">
        ...
        <div class="top_nav">
            <?php if(is_login()): ?><ul class="nav" style="margin-right:0">
                    <?php if($myinfo["is_init"] == 0 ): ?><li style="display: none;">
                            <p>该账号配置信息尚未完善，功能还不能使用</p>
                        </li>
                        <?php elseif($myinfo["is_audit"] == 0 and !$reg_audit_switch): ?>
                        <li style="display: none;">
                            <p>该账号配置信息已提交，请等待审核</p>
                        </li>
...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
      <div class="tab-content"> 
        <!-- 表单 -->
        <form id='form' action='http://localhost:84/index.php?s=/w17/Vote/ShopVote/option_edit.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-truename '>
			<label class='item-label'>参赛者</label>
			<div class='controls'><input type='text' class='text input-large' name='truename' value='测试1'></div></div>
<div class='form-item cf toggle-image '>
			<label class='item-label'>参赛图片</label>
			<div class='controls'><div class='controls uploadrow2' data-max='1' title='点击修改图片' rel='image'>
					<input type='file' id='upload_picture_image'>
					<input type='hidden' name='image' id='cover_id_image' value='831'/>
					<div class='upload-img-box'><div class='upload-pre-item2'><img width='100' height='100' src='http://localhost:84/Public/static/icon/colors/1187204.png'/></div><em class='edit_img_icon'>&nbsp;</em></div></div></div></div>
<div class='form-item cf toggle-manifesto '>
			<label class='item-label'>参赛宣言</label>
			<div class='controls'><label class='textarea input-large'><textarea name='manifesto'>请问</textarea></label></div></div>
<div class='form-item cf toggle-introduce '>
			<label class='item-label'>选手介绍</label>
			<div class='controls'><label class='textarea input-large'><textarea name='introduce'>请问</textarea></label></div></div>
<input type='hidden' name='vote_id' value='8' />
<div class='form-item cf toggle-phone '>
			<label class='item-label'>电话</label>
			<div class='controls'><input type='text' class='text input-large' name='phone' value='15010000000'></div></div>
<input type='hidden' name='id' value='41' />
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1506176773' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1506176773' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1506176773' charset='UTF-8'></script> 
  <script type='text/javascript'>
