...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    <div class="tab-content">
      <!-- 表单 -->
       <form id='form' action='http://localhost:84/index.php?s=/w17/Vote/ShopVote/add.html' method='POST' class='form-horizontal form-center'><div class='form-item cf toggle-title '>
...
<div class='form-item cf toggle-count '>
			<label class='item-label'><span class='need_flag'>*</span>最多参与人数</label>
			<div class='controls'><input type='number' class='text' name='count' value=''></div></div>
<div class='form-item form_bh'>
          <button class='btn submit-btn ajax-post' id='submit' type='submit' target-form='form-horizontal'>确 定</button></div></form>
<block name='script'>
  <link href='/Public/static/datetimepicker/css/datetimepicker.css?v=1506180942' rel='stylesheet' type='text/css'>
  <link href='/Public/static/datetimepicker/css/dropdown.css?v=1506180942' rel='stylesheet' type='text/css'>
  <script type='text/javascript' src='/Public/static/datetimepicker/js/bootstrap-datetimepicker.js'></script> 
  <script type='text/javascript' src='/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js?v=1506180942' charset='UTF-8'></script> 
  <script type='text/javascript'>
