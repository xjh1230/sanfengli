...
<head>
    <meta charset="UTF-8">
    <title><?php echo ($meta_title); ?>|三丰里社区管理平台</title>
        ...
        <table class="">
            ...
            <tbody>
                <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('User/changeStatus?method=forbidUser&id='.$vo['uid']);?>" class="ajax-get"><?php echo ($vo["status_text"]); ?></a>
                                    <?php else: ?>
                                    <a href="<?php echo U('User/changeStatus?method=resumeUser&id='.$vo['uid']);?>" class="ajax-get"><?php echo ($vo["status_text"]); ?></a><?php endif; ?>
                            </td>
                            <td>
                                <?php if(($vo["is_audit"]) == "1"): ?><a href="<?php echo U('User/changeStatus?method=audit_0&id='.$vo['uid']);?>" class="ajax-get"><?php echo ($vo["audit_text"]); ?></a>
                                    <?php else: ?>
                                    <a href="<?php echo U('User/changeStatus?method=audit_1&id='.$vo['uid']);?>" class="ajax-get"><?php echo ($vo["audit_text"]); ?></a><?php endif; ?>
                            </td>
